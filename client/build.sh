...
################### configs #################
SOCKET_UTILS_DIR=~/codes/application/Rechat/socket_utils
UTILS_DIR=~/codes/application/Rechat/utils
CWD=$PWD
SRC_DIR=$CWD/src
BUILD_DIR=$CWD/build
...
function compile_project()
{
    ...
    make -C $UTILS_DIR DBG=$DBG
    make -C $UTILS_DIR lib
}
